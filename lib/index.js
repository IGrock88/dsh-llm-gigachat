...
const Config = z.object({
  ...
  // Model ids whose requests have tools stripped entirely (weaker models:
  // they reject complex agent schemas with 422 or hallucinate tool calls).
  stripToolsFor: z.array(z.string()).default([])
});
  ...
  ctx.inject(["settings"], (settingsCtx) => {
    ...
    settingsCtx.settings.installSection(
      ...
      SettingsSchema,
      {
        ...
        stripToolsFor: config.stripToolsFor ?? []
      },
      {
